...
extern "C" {
    ...
    fn ffw_codec_parameters_get_codec_tag(params: *const c_void) -> c_uint;
    ...
    fn ffw_codec_parameters_set_channel_layout(params: *mut c_void, layout: *const c_void)
        -> c_int;
    fn ffw_codec_parameters_set_codec_tag(params: *mut c_void, codec_tag: c_uint);
    ...
    fn ffw_encoder_set_codec_tag(encoder: *mut c_void, codec_tag: c_uint);
